...
_Use when:_ the brand voice is loud, kinetic, sport-or-manifesto.
_Don't confuse with:_ Ft4 Dense colophon (which is static text).
...
_Anti-pattern:_ using Ft8 on editorial / quiet contexts — the motion reads as loud. Pair only with playful / sport / manifesto voices, and always honour `prefers-reduced-motion: reduce`.
