...
_Use when:_ the page wants a _closing line_ — editorial, manifesto, atmospheric. The sentence pairs with the page's argument.
_Don't confuse with:_ Ft1 Mast-headed (which leads with the wordmark, not a sentence).
...
_Anti-pattern:_ using a Statement footer on a docs root or hub. The sentence reads as marketing fluff there; default Ft3 instead.
