...
_Use when:_ the genre is playful (Brutal, Manifesto, Sport) or the brand voice is heavy / declarative.
_Don't confuse with:_ N1 Wordmark + 2 links (which is small and quiet).
...
_Anti-pattern:_ combining N7 with rounded corners, soft shadows, or backdrop-blur — those vocabularies fight. If you reach for blur, drop to N5; if you reach for round, drop to N1.
