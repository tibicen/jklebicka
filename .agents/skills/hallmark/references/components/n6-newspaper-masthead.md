...
_Use when:_ the page is editorial, magazine-shaped, or framed as an issue / edition.
_Don't confuse with:_ N1 Wordmark + 2 links (which is asymmetric and small).
...
_Anti-pattern:_ using N6 on a SaaS dashboard or a developer-tool product page. The masthead vocabulary belongs to long-form / editorial sites; on a B2B product, it reads as costume.
